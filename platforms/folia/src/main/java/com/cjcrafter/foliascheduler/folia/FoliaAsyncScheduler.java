...
public class FoliaAsyncScheduler implements AsyncSchedulerImplementation {
    ...
    @Override
    public <T> @NotNull TaskImplementation<T> runNow(
    ...
    @Override
    public <T> @NotNull TaskImplementation<T> runDelayed(
            @NotNull Function<TaskImplementation<T>, T> function,
            long delay,
    ...
    @Override
    public <T> @NotNull TaskImplementation<T> runAtFixedRate(
            @NotNull Function<TaskImplementation<T>, T> function,
            long delay,
            long period,
            @NotNull TimeUnit unit) {
        ...
        ScheduledTask scheduledTask =
                asyncScheduler.runAtFixedRate(plugin, foliaConsumer, delay, period, unit);
        taskImplementation.setScheduledTask(scheduledTask);
        return taskImplementation;
    }
}
